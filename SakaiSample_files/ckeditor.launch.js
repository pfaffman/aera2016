    ...
    var ckconfig = {
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['ResourceSearch', 'kaltura', 'Image','Movie','Flash','Iframe','Table','HorizontalRule','Smiley','SpecialChar','PageBreak','fmath_formula']
                : ['kaltura', 'Image','Movie','Flash','Iframe','Table','HorizontalRule','Smiley','SpecialChar','PageBreak', 'fmath_formula']),
            '/',
		...
		(function() { 
           ...
           CKEDITOR.plugins.addExternal('ckeditor_wiris',basePath+'ckeditor_wiris/', 'plugin.js');
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="movieplayer,wordcount,fmath_formula,aspell,kaltura,ckeditor_wiris";
    })();
